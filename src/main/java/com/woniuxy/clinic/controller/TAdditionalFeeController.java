...
//	public Object selecttAdditionalFeesajax(TAdditionalFee tAdditionalFee) {
//		List<TAdditionalFee> tAdditionalFees = tAdditionalFeeService.selectByWhere(tAdditionalFee);
//		CommonResult<TAdditionalFee> result = new CommonResult<TAdditionalFee>(0L, "成功", tAdditionalFees);
//		return result;
//		
//	}
